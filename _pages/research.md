...
<div class="row mt-4">
  <div class="col-sm-4">
    <img class="img-fluid rounded z-depth-1" src="/assets/img/research/forecasting.jpg" alt="Time-series forecasting">
  </div>
  <div class="col-sm-8">
...
<div class="row mt-4">
  <div class="col-sm-4">
    <img class="img-fluid rounded z-depth-1" src="/assets/img/research/networks.jpg" alt="Network analysis">
  </div>
  <div class="col-sm-8">
...
<div class="row mt-4">
  <div class="col-sm-4">
    <img class="img-fluid rounded z-depth-1" src="/assets/img/research/abm.jpg" alt="Agent-based modeling">
  </div>
  <div class="col-sm-8">
